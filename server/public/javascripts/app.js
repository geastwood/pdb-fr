...
/***/ function(module, exports, __webpack_require__) {
	...
	store.dispatch((0, _ActionTypes2['default'])());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createConnect = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Reducer
	 */
	var articles = function articles(_articles, action) {
	  if (_articles === undefined) _articles = {
	    isFetching: false,
	    items: []
	  };

	  switch (action.type) {
	    case _ActionTypes.FILTER_ARTICLE_BY_PUBLISHERS:
	      return Object.assign({}, _articles, { items: _articles.items.map(function (article) {
	          article.show = action.publishers.indexOf(article.publisher) !== -1;
	          return article;
	        }) });
	    case _ActionTypes.RESET_PUBLISHER_FILTER:
	      return Object.assign({}, _articles, { items: _articles.items.map(function (article) {
	          article.show = true;
	          return article;
	        }) });
	    case _ActionTypes.REQUEST_ARTICLES:
	      return Object.assign({}, _articles, { isFetching: true });
	    case _ActionTypes.RECEIVE_ARTICLES:
	      return Object.assign({}, _articles, { isFetching: false, items: action.items });
	    default:
	      return _articles;
	  }
	};
	...
	var publisherFilter = function publisherFilter(state, action) {
	  if (action === _ActionTypes.RESET_PUBLISHER_FILTER) {
	    return [];
	  }
	  return action.publishers || [];
	};

	exports.publisherFilter = publisherFilter;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.filterArticleByPub = filterArticleByPub;
	exports.resetPublisherFilter = resetPublisherFilter;
	...
	var FILTER_ARTICLE_BY_PUBLISHERS = 'FILTER_ARTICLE_BY_PUBLISHERS';
	exports.FILTER_ARTICLE_BY_PUBLISHERS = FILTER_ARTICLE_BY_PUBLISHERS;
	var RESET_PUBLISHER_FILTER = 'RESET_PUBLISHER_FILTER';

	exports.RESET_PUBLISHER_FILTER = RESET_PUBLISHER_FILTER;

	function filterArticleByPub(publishers) {
	  return { type: FILTER_ARTICLE_BY_PUBLISHERS, publishers: publishers };
	}
	...
	var RECEIVE_ARTICLES = 'RECEIVE_ARTICLES';
	exports.RECEIVE_ARTICLES = RECEIVE_ARTICLES;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleList = __webpack_require__(182);

	var _ArticleList2 = _interopRequireDefault(_ArticleList);

	var _PublisherSummary = __webpack_require__(185);

	var _PublisherSummary2 = _interopRequireDefault(_PublisherSummary);

	var _AuthorSummary = __webpack_require__(188);

	var _AuthorSummary2 = _interopRequireDefault(_AuthorSummary);
	...
	var App = _react2['default'].createClass({
	  ...
	  getPublishers: function getPublishers(articles) {
	  ...
	  getAuhtors: function getAuhtors(articles) {
	    return articles.filter(function (article) {
	      return article.show !== false;
	    }).reduce(function (rst, article) {
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'div',
	        { className: 'row' },
	        _react2['default'].createElement(_PublisherSummary2['default'], {
	          isFetching: this.props.articles.isFetching,
	          publishers: this.getPublishers(this.props.articles.items),
	          onPublisherClick: function (publishers) {
	            return _this.props.dispatch((0, _ActionTypes.filterArticleByPub)(publishers));
	          },
	          onResetPublisherFilter: function () {
	            return _this.props.dispatch((0, _ActionTypes.resetPublisherFilter)());
	          }
	        })
	      ),
	      ...
	      _react2['default'].createElement(
	        'div',
	        { className: 'row' },
	        _react2['default'].createElement(_AuthorSummary2['default'], {
	          isFetching: this.props.articles.isFetching,
	...
	exports['default'] = (0, _reactRedux.connect)(function (v) {
	  return v;
	})(App);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentProgressbar = __webpack_require__(184);

	var _componentProgressbar2 = _interopRequireDefault(_componentProgressbar);
	  ...
	  _createClass(ArticleList, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.isFetching) {
	        return _react2['default'].createElement(_componentProgressbar2['default'], { text: 'loading articles...' });
	      }
	      return _react2['default'].createElement(
	        'ul',
	        null,
	        this.props.articles.map(function (article, key) {
	          return _react2['default'].createElement(
	            'li',
	            { key: key, style: _this.getStyle(article) },
	            _react2['default'].createElement(_Article2['default'], article)
	          );
	        })
	      );
	    }
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        this.props['abstract'].slice(0, 100) + '...'
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PublisherItem = __webpack_require__(186);

	var _PublisherItem2 = _interopRequireDefault(_PublisherItem);
	...
	exports['default'] = _react2['default'].createClass({
	  displayName: 'PublisherSummary',

	  getPublishers: function getPublishers() {
	    return (0, _util.entry)((0, _util.group)(this.props.publishers), 'count');
	  },
	  render: function render() {
	    var _this = this;

	    if (this.props.isFetching) {
	      return _react2['default'].createElement(_componentProgressbar2['default'], { text: 'loading publishers...' });
	    }
	    var button = _react2['default'].createElement(
	      'li',
	      { key: 'publisher-filter-reset-btn',
	    ...
	    return _react2['default'].createElement(
	      ...
	      this.getPublishers().map(function (publisher, key) {
	        return _react2['default'].createElement(_PublisherItem2['default'], {
	          key: key,
	          publisher: publisher,
	          onPublisherClick: _this.props.onPublisherClick
	        });
	      }).concat(button)
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PublisherItem = (function (_Component) {
	  _inherits(PublisherItem, _Component);

	  function PublisherItem() {
	    _classCallCheck(this, PublisherItem);

	    _get(Object.getPrototypeOf(PublisherItem.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(PublisherItem, [{
	    key: 'render',
	    value: function render() {
	      var _this = this;
	      ...
	      return _react2['default'].createElement(
	        'li',
	        {
	          style: style,
	          onClick: function () {
	            return _this.props.onPublisherClick([publisher.name]);
	          }
	        },
	        _react2['default'].createElement(
	          'button',
...
/***/ function(module, exports) {
	...
	function group(arr) {
	  return arr.reduce(function (rst, key) {
	    if (rst[key]) {
	      rst[key].count++;
	    } else {
	      rst[key] = { count: 1 };
	...
	function entry(obj, prop) {
	  return Object.keys(obj).map(function (key) {
	    return { name: key, value: obj[key][prop] };
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AuthorSummary = (function (_Component) {
	  _inherits(AuthorSummary, _Component);

	  function AuthorSummary() {
	    _classCallCheck(this, AuthorSummary);

	    _get(Object.getPrototypeOf(AuthorSummary.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(AuthorSummary, [{
	    key: 'getAll',
	    value: function getAll() {
	      return (0, _util.entry)((0, _util.group)(this.props.authors), 'count');
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      if (this.props.isFetching) {
	        return _react2['default'].createElement(
	          ...
	          'Loading author\'s summary...'
	        );
	      }
	      return _react2['default'].createElement(
	        'ul',
	        { style: { listStyle: 'none' } },
	        this.getAll().map(function (author, i) {
	          return _react2['default'].createElement(
	            'li',
	            { key: i,
